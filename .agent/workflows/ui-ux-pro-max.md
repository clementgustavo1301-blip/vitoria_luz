...
| Issue | Solution |
|-------|----------|
| **Script not found** | Ensure you are running from the project root. |
| **Python encoding error** | Ensure your terminal supports UTF-8 (PowerShell: `[Console]::OutputEncoding = [System.Text.Encoding]::UTF8`). |
| **No results found** | Try broader keywords (e.g., "minimal" instead of "ultra-clean-minimalist"). |
...
- [ ] No layout shifts (CLS) — fixed aspect ratios
- [ ] LCP resources preloaded
- [ ] Critical CSS inlined (if possible)
